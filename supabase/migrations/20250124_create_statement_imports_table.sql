...
CREATE TABLE statement_imports (
  ...
  import_type TEXT NOT NULL CHECK (import_type IN ('consolidated', 'assets')),
...
COMMENT ON COLUMN statement_imports.import_type IS 'Type of import: consolidated or assets';
