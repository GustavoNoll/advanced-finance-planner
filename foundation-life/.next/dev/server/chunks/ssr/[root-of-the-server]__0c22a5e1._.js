...
"[project]/foundation-life/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function ms() {
    return M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../");
}
var xh = "libquery-engine";
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-darwin");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-darwin-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-debian-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-debian-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-debian-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-linux-static-x64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-linux-static-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-darwin.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-linux-musl.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../query_engine-windows.dll.node");
...
async function ml(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime/library.js").match(Qm()) === null, c = {
        searchedLocations: i,
...
async function Wm(e, r) {
    let t = await ir(), n = [], i = [
        r.dirname,
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), ".."),
        r.generator?.output?.value ?? ("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"),
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime"), "../../../.prisma/client"),
        "/tmp/prisma-engines",
        r.cwd
    ];
    ("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(ms());
    for (let o of i){
...
"[project]/foundation-life/src/generated/prisma/index.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/foundation-life/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)");
const Prisma = {};
...
config.dirname = ("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma"), 'schema.prisma'))) {
...
const { warnEnvConflicts } = __turbopack_context__.r("[project]/foundation-life/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma"), "libquery_engine-darwin-arm64.dylib.node");
path.join(process.cwd(), "src/generated/prisma/libquery_engine-darwin-arm64.dylib.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/foundation-life/src/generated/prisma"), "schema.prisma");
path.join(process.cwd(), "src/generated/prisma/schema.prisma");
}),
"[project]/foundation-life/src/lib/prisma.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/foundation-life/src/generated/prisma/index.js [app-rsc] (ecmascript)");
;
const prisma = global.prisma ?? new __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PrismaClient"]({
...
"[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40c3c71f87e5ea7d12c538759c67dc0c0d65be1af3":"getLifeData","600b891cdaa925d592b8f5aa6ab448824fa3e7f5ec":"saveLifeData","60930212137d8c346826a64f1c60690a51d72ad0dc":"deleteLifeMicroPlan","60e8724e899a70540d02df124b7c7f048ff7c3dfc1":"deleteLifeEvent","703fe47025d634bdd58f07b5cd064a57866d04822f":"updateLifeMicroPlan","70bc2341ebf592c74631753ee3e6ed36c6e9bd537b":"saveLifeMicroPlan","70f2553d7ae95e30f81f8fe1cf502e7d66ab08a3eb":"saveLifeEvent"},"",""] */ __turbopack_context__.s([
    "deleteLifeEvent",
    ()=>deleteLifeEvent,
    "deleteLifeMicroPlan",
    ()=>deleteLifeMicroPlan,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/foundation-life/src/lib/prisma.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/foundation-life/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
async function getLifeData(authUserId) {
    const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].profile.findUnique({
        where: {
            authUserId
        }
    });
    if (!profile?.birthDate) return null;
    const scenario = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeScenario.findFirst({
        where: {
    ...
    const microPlans = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.findMany({
        where: {
...
async function saveLifeData(authUserId, payload) {
    let profile = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].profile.findUnique({
        where: {
            authUserId
        }
    });
    ...
    if (!profile) {
        profile = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].profile.create({
            data: {
                authUserId,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].profile.update({
            where: {
                id: profile.id
            },
            data: {
    ...
    let scenario = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeScenario.findFirst({
        where: {
            profileId: profile.id,
            isDefault: true
        }
    ...
    if (!scenario) {
        scenario = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeScenario.create({
            data: {
                profileId: profile.id,
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeSettings.upsert({
        where: {
            scenarioId: scenario.id
        },
        create: {
...
async function saveLifeEvent(authUserId, scenarioId, payload) {
    const scenario = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeScenario.findFirst({
        where: {
            id: scenarioId,
            profile: {
    ...
    const event = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeEvent.create({
        data: {
            scenarioId,
            type: payload.type,
            title: payload.title,
...
async function deleteLifeEvent(authUserId, eventId) {
    const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].profile.findUnique({
        where: {
            authUserId
        }
    ...
    if (!profile) return;
    const event = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeEvent.findFirst({
        where: {
            id: eventId,
            scenario: {
                profileId: profile.id
    ...
    if (event) await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeEvent.delete({
        where: {
            id: eventId
        }
    });
}
async function saveLifeMicroPlan(authUserId, scenarioId, payload) {
    const scenario = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeScenario.findFirst({
        where: {
            id: scenarioId,
            profile: {
    ...
    if (!scenario) throw new Error('Scenario not found');
    const microPlan = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.create({
        data: {
            scenarioId,
...
async function updateLifeMicroPlan(authUserId, microPlanId, payload) {
    const microPlan = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.findFirst({
        where: {
            id: microPlanId,
            scenario: {
                profile: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.update({
        where: {
            id: microPlanId
        },
        data: {
...
async function deleteLifeMicroPlan(authUserId, microPlanId) {
    const microPlan = await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.findFirst({
        where: {
            id: microPlanId,
            scenario: {
    ...
    if (microPlan) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].lifeMicroPlan.delete({
            where: {
                id: microPlanId
            }
        });
...
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
    getLifeData,
    saveLifeData,
    saveLifeEvent,
    deleteLifeEvent,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getLifeData, "40c3c71f87e5ea7d12c538759c67dc0c0d65be1af3", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveLifeData, "600b891cdaa925d592b8f5aa6ab448824fa3e7f5ec", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveLifeEvent, "70f2553d7ae95e30f81f8fe1cf502e7d66ab08a3eb", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteLifeEvent, "60e8724e899a70540d02df124b7c7f048ff7c3dfc1", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(saveLifeMicroPlan, "70bc2341ebf592c74631753ee3e6ed36c6e9bd537b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateLifeMicroPlan, "703fe47025d634bdd58f07b5cd064a57866d04822f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteLifeMicroPlan, "60930212137d8c346826a64f1c60690a51d72ad0dc", null);
}),
"[project]/foundation-life/.next-internal/server/app/dashboard/page/actions.js { ACTIONS_MODULE0 => \"[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/foundation-life/.next-internal/server/app/dashboard/page/actions.js { ACTIONS_MODULE0 => \"[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "40c3c71f87e5ea7d12c538759c67dc0c0d65be1af3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getLifeData"],
    "600b891cdaa925d592b8f5aa6ab448824fa3e7f5ec",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveLifeData"],
    "60930212137d8c346826a64f1c60690a51d72ad0dc",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteLifeMicroPlan"],
    "60e8724e899a70540d02df124b7c7f048ff7c3dfc1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteLifeEvent"],
    "70bc2341ebf592c74631753ee3e6ed36c6e9bd537b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveLifeMicroPlan"],
    "70f2553d7ae95e30f81f8fe1cf502e7d66ab08a3eb",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveLifeEvent"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f2e$next$2d$internal$2f$server$2f$app$2f$dashboard$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/foundation-life/.next-internal/server/app/dashboard/page/actions.js { ACTIONS_MODULE0 => "[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$foundation$2d$life$2f$src$2f$app$2f$actions$2f$life$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/foundation-life/src/app/actions/life.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0c22a5e1._.js.map