...
import { downloadCSVTemplate, handleCSVImport, handlePDFImport, type ImportResult, type DataType } from "../utils/import-export"
...
export function ImportDialog({ open, onOpenChange, type, profileId, onImportSuccess }: ImportDialogProps) {
  ...
  const handlePDFFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      await handlePDFImport(file, type, profileId)
      toast({
