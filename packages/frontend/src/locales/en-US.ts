export const enUS = { 
  ...
  brokerDashboard: {
    ...
    statementImports: {
      ...
      last10Imports: "Last 10 imports from your clients",
  ...
  meetingNotes: {
    ...
    formDescription: "Document key points and action items from your client meeting.",
    form: {
      meetingDate: "Meeting Date",
      title: "Title",
      titlePlaceholder: "e.g. Quarterly portfolio review",
      content: "Content",
      contentPlaceholder: "Main discussion points, decisions made...",
      actionItems: "Action Items",
      addActionItem: "Add",
      actionItemPlaceholder: "e.g. Send new allocation proposal by 20/03",
      participants: "Participants",
      participantsPlaceholder: "e.g. João Silva, Maria Santos",
    },
    actionItems: "action items",
    empty: {
      title: "No meeting notes yet",
      description: "Create your first note to document discussions, decisions, and action items from client meetings.",
    ...
    createSuccess: "Meeting note created successfully",
    createError: "Error creating meeting note",
    updateSuccess: "Meeting note updated successfully",
    updateError: "Error updating meeting note",
    deleteSuccess: "Meeting note deleted successfully",
    deleteError: "Error deleting meeting note",
    deleteConfirmTitle: "Delete meeting note?",
  ...
  portfolioPerformance: {
    // All asset class and grouped strategy translations
    common: {
      // Individual asset classes
      cdi_liquidity: "CDI - Liquidity",
      cdi_bonds: "CDI - Bonds",
      cdi_funds: "CDI - Funds",
      inflation_bonds: "Inflation - Bonds",
      inflation_funds: "Inflation - Funds",
      pre_fixed_bonds: "Pre Fixed - Bonds",
      pre_fixed_funds: "Pre Fixed - Funds",
      multimarket: "Multimarket",
      real_estate_assets: "Real Estate - Assets",
      real_estate_funds: "Real Estate - Funds",
      stocks_assets: "Stocks - Assets",
      stocks_etfs: "Stocks - ETFs",
      stocks_funds: "Stocks - Funds",
      stocks_long_biased: "Stocks - Long Bias",
      ...
      gold: "Gold",
      others: "Others",
      // Grouped strategies (some already above as asset classes)
      cdi: "CDI",
      inflation: "Inflation",
      pre_fixed: "Pre Fixed",
    ...
    dataManagement: {
      ...
      import: {
        ...
        uploadPDF: "3. Import statement",
        uploadPDFDescription: "Send a PDF statement for automatic processing.",
        selectPDF: "Import statement",
    ...
    kpi: {
      ...
      diversificationDialog: {
        ...
        description: "Analysis of diversification evolution over time",
        currentAssets: "Current Assets",
        currentStrategies: "Active Strategies",
        assetClasses: "asset classes",
        inPeriod: "in period {{period}}",
        assetsEvolution: "Assets Evolution",
        strategiesTimeline: "Strategies Timeline",
        strategiesTimelineDescription: "Presence of each asset class over time",
        strategies: "Strategies",
        activeStrategies: "active strategies",
        clickToFilter: "Click on strategies below to filter the chart",
        active: "Active",
        month: "month",
        months: "months"
      },
