export const ptBR = { 
  ...
  brokerDashboard: {
    ...
    statementImports: {
      ...
      last10Imports: "Últimas 10 importações dos seus clientes",
  ...
  meetingNotes: {
    ...
    formDescription: "Documente os principais pontos e itens de ação da reunião com o cliente.",
    form: {
      meetingDate: "Data da Reunião",
      title: "Título",
      titlePlaceholder: "ex: Revisão trimestral de portfólio",
      content: "Conteúdo",
      contentPlaceholder: "Principais pontos discutidos, decisões tomadas...",
      actionItems: "Itens de Ação",
      addActionItem: "Adicionar",
      actionItemPlaceholder: "ex: Enviar proposta de nova alocação até 20/03",
      participants: "Participantes",
      participantsPlaceholder: "ex: João Silva, Maria Santos",
    },
    actionItems: "itens de ação",
    empty: {
      title: "Nenhuma nota de reunião ainda",
      description: "Crie sua primeira nota para documentar discussões, decisões e itens de ação das reuniões com clientes.",
    ...
    createSuccess: "Nota de reunião criada com sucesso",
    createError: "Erro ao criar nota de reunião",
    updateSuccess: "Nota de reunião atualizada com sucesso",
    updateError: "Erro ao atualizar nota de reunião",
    deleteSuccess: "Nota de reunião excluída com sucesso",
    deleteError: "Erro ao excluir nota de reunião",
    deleteConfirmTitle: "Excluir nota de reunião?",
  ...
  adminDashboard: {
    ...
    statementImports: {
      ...
      quantity: 'Quantidade',
      recentImports: 'Últimas Importações',
      last10Imports: 'Últimas 10 importações',
      noImports: 'Nenhuma importação encontrada',
      client: 'Cliente',
      broker: 'Broker',
      type: 'Tipo',
  ...
  portfolioPerformance: {
    // Todas as traduções de asset classes e estratégias agrupadas
    common: {
      // Asset classes individuais
      cdi_liquidity: "CDI - Liquidez",
      cdi_bonds: "CDI - Títulos",
      cdi_funds: "CDI - Fundos",
      inflation_bonds: "Inflação - Títulos",
      inflation_funds: "Inflação - Fundos",
      pre_fixed_bonds: "Pré Fixado - Títulos",
      ...
      stocks_long_biased: "Ações - Long Bias",
      ...
      gold: "Ouro",
      others: "Outros",
      // Estratégias agrupadas (algumas já estão acima como asset classes)
      cdi: "CDI",
      inflation: "Inflação",
    ...
    dataManagement: {
      ...
      import: {
        ...
        uploadPDF: "3. Importar extrato",
        uploadPDFDescription: "Envie um extrato em PDF para processamento automático.",
        selectPDF: "Importar extrato",
      ...
      importPDF: {
        ...
        searchInstitution: "Buscar instituição...",
