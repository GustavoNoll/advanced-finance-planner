...
import { CompetenceSelector } from "@/features/portfolio-performance/components/competence-selector";
import { ClientDataDisplay } from "@/features/portfolio-performance/components/client-data-display";
import { PortfolioTable } from "@/features/portfolio-performance/components/portfolio-table";
import { MaturityDialog } from "@/features/portfolio-performance/components/maturity-dialog";
import { DiversificationDialog } from "@/features/portfolio-performance/components/diversification-dialog";
import { IssuerExposure } from "@/features/portfolio-performance/components/issuer-exposure";
import { MaturityTimeline } from "@/features/portfolio-performance/components/maturity-timeline";
import { InvestmentDetailsTable } from "@/features/portfolio-performance/components/investment-details-table";
import { StrategyBreakdown } from "@/features/portfolio-performance/components/strategy-breakdown";
import { CurrencyToggle } from "@/features/portfolio-performance/components/currency-toggle";
import { PerformanceChart } from "@/features/portfolio-performance/components/performance-chart";
import { AssetReturnsTable } from "@/features/portfolio-performance/components/asset-returns-table";
